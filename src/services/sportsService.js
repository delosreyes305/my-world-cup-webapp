...
export const TEAM_METADATA = {
  // Official FIFA Rankings — July 20, 2026 (post World Cup 2026)
  // ── UEFA ──────────────────────────────────────────────
...
const WC2026_SCORERS = [
  ...
  { id: 4,  name: 'Erling Haaland',         nation: 'Norway',       goals: 7,  assists: 0, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Man City',         age: 25, rating: '9.1', height: '1.94m', weight: '88kg', caps: 42,  intlGoals: 38 },
  { id: 5,  name: 'Ousmane Dembélé',        nation: 'France',       goals: 6,  assists: 2, yellowCards: 1, redCards: 0, pos: 'FW', club: 'PSG',              age: 27, rating: '8.7', height: '1.78m', weight: '67kg', caps: 72,  intlGoals: 18 },
  { id: 6,  name: 'Harry Kane',             nation: 'England',      goals: 6,  assists: 2, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Bayern Munich',   age: 31, rating: '8.8', height: '1.88m', weight: '86kg', caps: 91,  intlGoals: 72 },
  { id: 7,  name: 'Mikel Oyarzabal',        nation: 'Spain',        goals: 5,  assists: 1, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Real Sociedad',   age: 27, rating: '8.6', height: '1.82m', weight: '75kg', caps: 43,  intlGoals: 21 },
  { id: 8,  name: 'Ismaila Sarr',           nation: 'Senegal',      goals: 4,  assists: 1, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Marseille',       age: 26, rating: '8.3', height: '1.87m', weight: '80kg', caps: 58,  intlGoals: 14 },
  { id: 9,  name: 'Julian Quiñones',        nation: 'Mexico',       goals: 4,  assists: 1, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Club América',    age: 28, rating: '8.2', height: '1.75m', weight: '72kg', caps: 31,  intlGoals: 12 },
  { id: 10, name: 'Vinicius Jr',            nation: 'Brazil',       goals: 4,  assists: 1, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Real Madrid',     age: 24, rating: '9.0', height: '1.76m', weight: '73kg', caps: 53,  intlGoals: 17 },
  { id: 11, name: 'Bukayo Saka',            nation: 'England',      goals: 3,  assists: 3, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Arsenal',         age: 24, rating: '8.8', height: '1.78m', weight: '72kg', caps: 52,  intlGoals: 18 },
  { id: 12, name: 'Lautaro Martínez',       nation: 'Argentina',    goals: 3,  assists: 1, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Inter Milan',     age: 27, rating: '8.7', height: '1.74m', weight: '79kg', caps: 72,  intlGoals: 35 },
  { id: 13, name: 'Romelu Lukaku',          nation: 'Belgium',      goals: 3,  assists: 1, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Napoli',          age: 31, rating: '8.3', height: '1.90m', weight: '94kg', caps: 114, intlGoals: 78 },
  { id: 14, name: 'Jonathan David',         nation: 'Canada',       goals: 3,  assists: 0, yellowCards: 1, redCards: 0, pos: 'FW', club: 'PSG',             age: 25, rating: '8.5', height: '1.76m', weight: '75kg', caps: 47,  intlGoals: 28 },
  { id: 15, name: 'Cristiano Ronaldo',      nation: 'Portugal',     goals: 3,  assists: 0, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Al Nassr',        age: 41, rating: '8.6', height: '1.87m', weight: '83kg', caps: 222, intlGoals: 137 },
  { id: 16, name: 'Kai Havertz',            nation: 'Germany',      goals: 3,  assists: 0, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Arsenal',         age: 26, rating: '8.4', height: '1.90m', weight: '83kg', caps: 58,  intlGoals: 24 },
  { id: 17, name: 'Cody Gakpo',             nation: 'Netherlands',  goals: 3,  assists: 1, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Liverpool',       age: 25, rating: '8.4', height: '1.89m', weight: '80kg', caps: 42,  intlGoals: 16 },
  { id: 18, name: 'Lamine Yamal',           nation: 'Spain',        goals: 2,  assists: 3, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Barcelona',       age: 18, rating: '9.0', height: '1.75m', weight: '65kg', caps: 26,  intlGoals: 9 },
  { id: 19, name: 'Rodri',                  nation: 'Spain',        goals: 1,  assists: 3, yellowCards: 3, redCards: 0, pos: 'MF', club: 'Man City',        age: 29, rating: '9.2', height: '1.91m', weight: '82kg', caps: 74,  intlGoals: 19 },
  { id: 20, name: 'Ferran Torres',          nation: 'Spain',        goals: 1,  assists: 0, yellowCards: 0, redCards: 0, pos: 'FW', club: 'Barcelona',       age: 25, rating: '8.5', height: '1.82m', weight: '76kg', caps: 49,  intlGoals: 23 },
]

const WC2026_ASSISTS = [
  { id: 51, name: 'Michael Olise',          nation: 'France',       goals: 1,  assists: 7, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Bayern Munich',   age: 23, rating: '8.6', height: '1.81m', weight: '70kg', caps: 22,  intlGoals: 5 },
  { id: 52, name: 'Martin Ødegaard',        nation: 'Norway',       goals: 2,  assists: 4, yellowCards: 1, redCards: 0, pos: 'MF', club: 'Arsenal',         age: 27, rating: '8.7', height: '1.78m', weight: '68kg', caps: 76,  intlGoals: 17 },
  { id: 1,  name: 'Kylian Mbappé',          nation: 'France',       goals: 10, assists: 4, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Real Madrid',     age: 27, rating: '9.5', height: '1.78m', weight: '73kg', caps: 96,  intlGoals: 57 },
  { id: 53, name: 'Brahim Díaz',            nation: 'Morocco',      goals: 1,  assists: 4, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Real Madrid',     age: 25, rating: '8.4', height: '1.71m', weight: '60kg', caps: 28,  intlGoals: 5 },
  { id: 54, name: 'Bruno Guimarães',        nation: 'Brazil',       goals: 0,  assists: 4, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Newcastle',       age: 27, rating: '8.5', height: '1.82m', weight: '76kg', caps: 38,  intlGoals: 3 },
  { id: 2,  name: 'Lionel Messi',           nation: 'Argentina',    goals: 8,  assists: 4, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Inter Miami',     age: 38, rating: '9.4', height: '1.70m', weight: '72kg', caps: 194, intlGoals: 116 },
  { id: 11, name: 'Bukayo Saka',            nation: 'England',      goals: 3,  assists: 3, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Arsenal',         age: 24, rating: '8.8', height: '1.78m', weight: '72kg', caps: 52,  intlGoals: 18 },
  { id: 18, name: 'Lamine Yamal',           nation: 'Spain',        goals: 2,  assists: 3, yellowCards: 1, redCards: 0, pos: 'FW', club: 'Barcelona',       age: 18, rating: '9.0', height: '1.75m', weight: '65kg', caps: 26,  intlGoals: 9 },
  { id: 19, name: 'Rodri',                  nation: 'Spain',        goals: 1,  assists: 3, yellowCards: 3, redCards: 0, pos: 'MF', club: 'Man City',        age: 29, rating: '9.2', height: '1.91m', weight: '82kg', caps: 74,  intlGoals: 19 },
...
const WC2026_YELLOWS = [
  { id: 61, name: 'Issa Diop',              nation: 'Morocco',      goals: 0,  assists: 0, yellowCards: 3, redCards: 0, pos: 'DF', club: 'Fulham',          age: 27, rating: '7.3', height: '1.92m', weight: '92kg', caps: 18,  intlGoals: 0 },
  { id: 62, name: 'Mohanad Lashin',         nation: 'Egypt',        goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Zamalek',         age: 26, rating: '7.0', height: '1.80m', weight: '74kg', caps: 14,  intlGoals: 1 },
  { id: 63, name: 'Marawan Attia',          nation: 'Egypt',        goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Al Ahly',         age: 25, rating: '6.9', height: '1.76m', weight: '70kg', caps: 11,  intlGoals: 0 },
  { id: 64, name: 'Luc De Fougerolles',     nation: 'Canada',       goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'DF', club: 'Vancouver',       age: 25, rating: '7.0', height: '1.85m', weight: '78kg', caps: 8,   intlGoals: 0 },
  { id: 65, name: 'Haissem Hassan',         nation: 'Egypt',        goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Al Masry',        age: 24, rating: '7.1', height: '1.74m', weight: '68kg', caps: 12,  intlGoals: 3 },
  { id: 66, name: 'Caleb Yirenkyi',         nation: 'Ghana',        goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Young Boys',      age: 23, rating: '7.0', height: '1.78m', weight: '72kg', caps: 9,   intlGoals: 0 },
  { id: 67, name: 'Yasser Ibrahim',         nation: 'Egypt',        goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'DF', club: 'Al Ahly',         age: 27, rating: '7.2', height: '1.83m', weight: '80kg', caps: 21,  intlGoals: 1 },
  { id: 68, name: 'Teboho Mokoena',         nation: 'South Africa', goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Mamelodi Sundowns',age: 27,rating: '7.3', height: '1.78m', weight: '72kg', caps: 34,  intlGoals: 4 },
  { id: 69, name: 'Cyle Larin',             nation: 'Canada',       goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Mallorca',        age: 29, rating: '7.4', height: '1.86m', weight: '84kg', caps: 61,  intlGoals: 26 },
  { id: 70, name: 'Gervane Kastaneer',      nation: 'Curaçao',      goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Hammarby',        age: 30, rating: '7.0', height: '1.78m', weight: '74kg', caps: 22,  intlGoals: 5 },
  { id: 71, name: 'Juninho Bacuna',         nation: 'Curaçao',      goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Birmingham',      age: 27, rating: '7.1', height: '1.84m', weight: '78kg', caps: 29,  intlGoals: 3 },
  { id: 72, name: 'Sidny Lopes Cabral',     nation: 'Cape Verde Islands', goals: 0, assists: 0, yellowCards: 2, redCards: 0, pos: 'DF', club: 'Vitória',   age: 26, rating: '7.0', height: '1.80m', weight: '76kg', caps: 14,  intlGoals: 0 },
  { id: 73, name: 'Declan Rice',            nation: 'England',      goals: 0,  assists: 1, yellowCards: 2, redCards: 0, pos: 'MF', club: 'Arsenal',         age: 26, rating: '8.4', height: '1.85m', weight: '81kg', caps: 62,  intlGoals: 3 },
  { id: 74, name: 'Renato Veiga',           nation: 'Portugal',     goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'DF', club: 'Chelsea',         age: 21, rating: '7.4', height: '1.89m', weight: '81kg', caps: 14,  intlGoals: 1 },
  { id: 75, name: 'Ivan Perišić',           nation: 'Croatia',      goals: 0,  assists: 0, yellowCards: 2, redCards: 0, pos: 'FW', club: 'Hajduk Split',    age: 35, rating: '7.2', height: '1.88m', weight: '80kg', caps: 126, intlGoals: 34 },
  { id: 19, name: 'Rodri',                  nation: 'Spain',        goals: 1,  assists: 3, yellowCards: 3, redCards: 0, pos: 'MF', club: 'Man City',        age: 29, rating: '9.2', height: '1.91m', weight: '82kg', caps: 74,  intlGoals: 19 },
]

const WC2026_REDS = [
  { id: 81, name: 'Sphephelo Sithole',      nation: 'South Africa', goals: 0,  assists: 0, yellowCards: 0, redCards: 1, pos: 'DF', club: 'Mamelodi Sundowns',age: 27,rating: '6.8', height: '1.75m', weight: '70kg', caps: 12,  intlGoals: 0 },
  { id: 82, name: 'Themba Zwane',           nation: 'South Africa', goals: 0,  assists: 0, yellowCards: 0, redCards: 1, pos: 'MF', club: 'Mamelodi Sundowns',age: 32,rating: '7.0', height: '1.67m', weight: '65kg', caps: 49,  intlGoals: 9 },
  { id: 83, name: 'Cesar Montes',           nation: 'Mexico',       goals: 0,  assists: 0, yellowCards: 0, redCards: 1, pos: 'DF', club: 'Espanyol',        age: 27, rating: '7.0', height: '1.90m', weight: '80kg', caps: 31,  intlGoals: 1 },
  { id: 84, name: 'Hwang Hee-chan',         nation: 'South Korea',  goals: 0,  assists: 0, yellowCards: 0, redCards: 1, pos: 'FW', club: 'Wolverhampton',   age: 28, rating: '6.9', height: '1.76m', weight: '68kg', caps: 55,  intlGoals: 12 },
  { id: 85, name: 'Jean-Ricner Bellegarde', nation: 'Haiti',        goals: 0,  assists: 0, yellowCards: 3, redCards: 1, pos: 'MF', club: 'Strasbourg',      age: 26, rating: '7.1', height: '1.76m', weight: '68kg', caps: 18,  intlGoals: 2 },
  { id: 86, name: 'Breel Embolo',           nation: 'Switzerland',  goals: 1,  assists: 0, yellowCards: 1, redCards: 1, pos: 'FW', club: 'Monaco',          age: 29, rating: '7.3', height: '1.87m', weight: '85kg', caps: 58,  intlGoals: 16 },
  { id: 87, name: 'Assim Madibo',           nation: 'Qatar',        goals: 0,  assists: 0, yellowCards: 0, redCards: 1, pos: 'MF', club: 'Al-Duhail',       age: 26, rating: '6.5', height: '1.80m', weight: '74kg', caps: 19,  intlGoals: 1 },
  { id: 88, name: 'Enzo Fernández',         nation: 'Argentina',    goals: 0,  assists: 1, yellowCards: 2, redCards: 1, pos: 'MF', club: 'Chelsea',         age: 24, rating: '7.8', height: '1.78m', weight: '73kg', caps: 38,  intlGoals: 4 },
]
...
export async function getTopScorers() {
  ...
  return _sortByStat(res0.map(raw => normalizePlayer(raw)), 'goals')
}
...
export async function getTopAssists() {
  ...
  return _sortByStat(res1.map(raw => normalizePlayer(raw)), 'assists')
}
...
export async function getTopYellowCards() {
  ...
  return _sortByStat(res2.map(raw => normalizePlayer(raw)), 'yellowCards')
}
...
export async function getTopRedCards() {
  ...
  return _sortByStat(res3.map(raw => normalizePlayer(raw)), 'redCards')
}
